...
def img_augmentation(path, name_int,save_path):
    img = cv2.imread(path)
...
if __name__ == '__main__':
    directory_name = 'picture/retriArea/'
    save_path = directory_name + 'augment/'
    for filename in os.listdir(r"./"+directory_name):
        print(save_path + filename)
        img_augmentation(directory_name+filename,1, save_path + filename)
