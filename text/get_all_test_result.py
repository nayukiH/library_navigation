r"""
Example usage:
~/models/research$ python get_all_test_result.py --test_images_path=test_images/ --model_path=new_data_copy/frozen_inference_graph.pb --label_path=new_data_copy/label_map.pbtxt
"""
...
PATH_TO_TEST_IMAGES = FLAGS.test_images_path # "test_images/"
#MODEL_NAME = 'new_data_copy'
PATH_TO_CKPT = FLAGS.model_path # MODEL_NAME + '/frozen_inference_graph.pb'
PATH_TO_LABELS = FLAGS.label_path # MODEL_NAME+'/label_map.pbtxt'
NUM_CLASSES = 5
...
#             print("Time taken : {0} seconds".format(seconds))
    data_df.to_csv('./new_detect_result', index=None)
    print('Successfully create csv.')
